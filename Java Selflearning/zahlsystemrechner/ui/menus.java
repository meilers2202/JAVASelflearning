...
public class menus {
    ...
    public static void mainMenu(Scanner scanner, int menu, ResourceBundle messages) {
        switch (menu) {
            case 1 -> zahlensystem2.dezimalMenu(scanner);
            case 2 -> zahlensystem2.binaerMenu(scanner);
            case 3 -> zahlensystem2.hexMenu(scanner);
    ...
    public static void dezimalMenu(ResourceBundle messages, Scanner scanner, int choice) {
        while (true) {
            switch (choice) {
                ...
                case 3 -> {
                    zahlensystem2.mainMenu(scanner);
                    return;
                }
                default -> {
                    errors.invalidNumber(messages);
            ...
            switch (choice) {
                case 1 -> {
                    ...
                    if (!bin.matches("[01]+")) {
                        ...
                        zahlensystem2.waitForKeypress(scanner);
                        zahlensystem2.binaerMenu(scanner);
                    }
                    try {
